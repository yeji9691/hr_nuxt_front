...
//     const diffDate = new Date(endDate.value) - new Date(startDate.value);
...
<template>
  <VContainer class="mb-6">
    <VRow>
      ...
      <VCol cols="12" md="2">
        <AppSelect v-model="selectedRest" label="신청유형" placeholder="신청유형" :items="restProps" :item-props="itemProps"
